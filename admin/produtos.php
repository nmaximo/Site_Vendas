...
$Categoria_id = $Sub_categoria_id = 0;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($_POST["categoria"])) {
        $Categoria_id_err = "Introduza a categoria.";
    } else {
    ...
    if (empty($nome_err) && empty($codigo_err) && empty($preco_err) && empty($descricao_err) && empty($Categoria_id_err) && empty($Sub_categoria_id_err)) {
        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            mysqli_stmt_bind_param($stmt, "ssssii", $param_nome, $param_codigo, $param_preco, $param_descricao, $param_Categoria_id, $param_Sub_categoria_id);
    ...
    <form action="produtos.php" method="post">
        ...
        <div class="dropdown">
            ...
            <select name="categoria">
                <option type="text" name="categoria" class="form-control" value="dropbox categoria">Escolha as
                    categorias
                </option>
                <?php
        ...
        <div class="dropdown">
            ...
            <select name="sub_categoria">
                <option type="text" name="sub_categoria" class="form-control" value="dropbox sub_categorias">Escolha as
                    sub-categorias
                </option>
                <?php
