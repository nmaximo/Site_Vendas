...
<th scope='col'>Categoria</th>";
    ...
    while ($row = $result->fetch_assoc()) {
        print
            "<tr><td>" . $row['id'] . "</td>
<td>" . $row['nome'] . "</td>
<td> <align center><a href='eliminar_categoria2.php?id=" . $row['id'] . "' class=\"btn btn-danger btn-sm\" role='button' onclick=\"return confirm('Tem certeza de que deseja excluir este item?');\"> Eliminar</a></td>
 </tr>";
